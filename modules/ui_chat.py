...
def create_ui():
    ...
    with gr.Tab('Chat', elem_id='chat-tab'):
        ...
        with gr.Row():
            shared.gradio['prompt_history'] = gr.Textbox(label='prompt_history',value = shared.prompt_history,)
...
def create_event_handlers():
    ...
    shared.gradio['Generate'].click(
        ...
        lambda:shared.prompt_history,None,gradio("prompt_history")).then(
        ui.gather_interface_values, gradio(shared.input_elements), gradio('interface_state')).then(
    ...
    shared.gradio['Clear history'].click(lambda: [gr.update(visible=True), gr.update(visible=False), gr.update(visible=True)], None, gradio(clear_arr)).then(
        lambda: '', None, gradio('prompt_history'))
